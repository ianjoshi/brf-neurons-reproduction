...
import os
import sys
sys.path.append("../../../PycharmProjects/brf-neurons-reproduction/experiments")
import snn
...
if "vrf" in neuron:
    ...
    sub_seq_length = 0
    # vrf (without reset) x: test acc. of saved model 90.15 %
    ...
    # brf x: test acc. of saved model 92.27 %
    ...
    # alif x: test acc. of saved model 73.63 %
